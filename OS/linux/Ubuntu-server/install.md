...
Ubuntu 20.04는 2025년 5월에 표준 지원이 끝났습니다. 새로 설치한다면 Ubuntu 26.04 LTS를 선택하고, 기존 20.04 서버를 유지한다면 Ubuntu Pro를 적용하거나 지원 중인 LTS로 업그레이드해야 합니다. 화면 구성은 달라졌지만 아래의 설치 흐름 자체는 같습니다.
